...
int bmi323_core_probe(struct device *dev)
{
	...
	data->runtime_pm_status.reg_settings[6].reg = BMI323_FIFO_CONF_REG;
	data->runtime_pm_status.reg_settings[7].reg = BMI323_FEAT_IO0_REG;
	data->runtime_pm_status.reg_settings[8].reg = BMI323_FIFO_WTRMRK_REG;
	data->runtime_pm_status.reg_settings[9].reg = BMI323_FIFO_CTRL_REG;
...
void bmi323_core_remove(struct device *dev)
{
	...
	/*
	 * Place the peripherial in its lowest power consuming state.
	 */
	if (regmap)
